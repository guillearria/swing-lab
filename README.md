...
| `python3 -m research.book` | **The RETIRED real-money book [ARC 5 #12] — TERMINAL since 2026-08-18** (liquidated 08-17; closing verdict FINDINGS [ARC 5 #13]): every command prints one BOOK CLOSED line; `book.csv`/`book_equity.csv` stay tracked as frozen evidence. Long-realm personal assets live in the private long-term repo, never here |
